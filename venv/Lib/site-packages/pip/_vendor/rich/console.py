    ...
    def print_exception(
        ...
        *,
        ...
        Args:
            ...
            show_locals (bool, optional): Enable display of local env_vars. Defaults to False.
    ...
    def _caller_frame_info(
        ...
        Returns:
            Tuple[str, int, Dict[str, Any]]: A tuple containing the filename, the line number and
                the dictionary of local env_vars associated with the caller frame.
    ...
    def export_svg(
        ...
        *,
        ...
        Args:
            ...
            clear (bool, optional): Clear record buffer after exporting. Defaults to ``True``
            code_format (str, optional): Format string used to generate the SVG. Rich will inject a number of env_vars
                into the string in order to form the final SVG output. The default template used and the env_vars
