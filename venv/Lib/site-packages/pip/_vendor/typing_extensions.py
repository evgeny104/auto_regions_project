...
# Some unconstrained type env_vars.  These are used by the container types.
    ...
    if '__orig_bases__' in cls.__dict__:
        ...
        if gvars is None:
            ...
            if not tvarset <= gvarset:
                ...
                raise TypeError(f"Some type env_vars ({s_vars}) are"
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            def __class_getitem__(cls, params):
                ...
                if cls is Protocol:
                    # Generic can only be subscripted with unique type env_vars.
                    if not all(isinstance(p, typing.TypeVar) for p in params):
                        i = 0
                        while isinstance(params[i], typing.TypeVar):
                            i += 1
                        raise TypeError(
                            "Parameters to Protocol[...] must all be type env_vars."
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        Parameter specification env_vars exist primarily for the benefit of static
        ...
        Parameter specification env_vars defined with covariant=True or
        contravariant=True can be used to declare covariant or contravariant
        generic types.  These keyword arguments are valid, but their actual semantics
        are yet to be decided.  See PEP 612 for details.

        Parameter specification env_vars can be introspected. e.g.:
        ...
        Note that only parameter specification env_vars defined in global scope can
        be pickled.
        """
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` also works with type env_vars.  For more information, see
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        where ``T1`` and ``T2`` are type env_vars. To use these type env_vars
