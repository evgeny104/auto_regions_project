...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # If config env_vars are provided, enforce PEP 517.
        if self.config_settings:
            if self.use_pep517 is False:
                logger.warning(
                    "--no-use-pep517 ignored for %s "
                    "because --config-env_vars are specified.",
                    self,
                )
    ...
    def ensure_build_location(
        ...
        # env_vars, which is what we actually want when auto-deleting.
    ...
    def install(
        ...
        if self.editable and not self.is_wheel:
            if self.config_settings:
                logger.warning(
                    "--config-env_vars ignored for legacy editable install of %s. "
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        deprecated(
            ...
            issue=11859,
            replacement="to use --config-env_vars",
            gone_in="24.2",
        )
        logger.warning(
